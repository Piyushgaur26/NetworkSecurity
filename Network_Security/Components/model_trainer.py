...
class ModelTrainer:
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        # Evaluate models and retrieve their performance scores
        ...
        # Identify the best-performing model based on score
        ...
        # tracks the experiments with mlflow
        ...
        # Load preprocessing object used during data transformation
        ...
        # Wrap preprocessor and model into a single object for deployment
        ...
        # Push best model to a final output location
